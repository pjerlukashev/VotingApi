...
import static ru.lukashev.vote.DishTestData.DISH10;
...
public class AdminRestaurantControllerTest extends AbstractControllerTest {
    ...
    void testGetAllDishesOfTheRestaurant()throws Exception{
        ...
        mockMvc.perform(get(REST_URL + "/" + 100002 + "/dishes"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    void testGetDishOfTheRestaurant() throws Exception{
        mockMvc.perform(get(REST_URL + "/" + 100002 + "/dishes/" + DISH1_ID))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    void deleteDishOfTheRestaurant() throws Exception{
        ...
        mockMvc.perform(delete(REST_URL + "/" + 100002 + "/dishes/" + DISH1_ID))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(status().isNoContent());
   ...
   @Test
    void createDishOfTheRestaurantWithLocation()throws Exception{
       ...
       ResultActions action = mockMvc.perform(post(REST_URL + "/" + 100002 + "/dishes/")
               .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateDishOfTheRestaurant() throws Exception{
       ...
       DishTo updatedTo = new DishTo(DISH1_ID, "okroshka", 100);
        mockMvc.perform(put(REST_URL + "/" + 100002 + "/dishes/" + DISH1_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void testGetAllEnabled()throws Exception{
        ...
        mockMvc.perform(get(REST_URL + "/" + 100002 + "/dishes/enabled"))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    void testSetEnabled() throws Exception{
        ...
        mockMvc.perform(put(REST_URL + "/" + 100002 + "/dishes "+ 100012 +"/enabled?enabled=true"))
                .andDo(print())
                .andExpect(status().isNoContent());
